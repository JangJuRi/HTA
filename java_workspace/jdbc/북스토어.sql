...
(
	...
	CONSTRAINT SYS_C007012 PRIMARY KEY (BOOK_NO)
);
...
(
	...
	CONSTRAINT SYS_C007029 PRIMARY KEY (ANSWER_NO)
);
...
(
	...
	CONSTRAINT SYS_C007017 PRIMARY KEY (ORDER_NO)
);
...
(
	...
	CONSTRAINT SYS_C007026 PRIMARY KEY (QUESTION_NO)
);
...
(
	...
	CONSTRAINT SYS_C007016 PRIMARY KEY (USER_ID)
);
...
ALTER TABLE HR.SAMPLE_BOOK_ORDERS
	ADD CONSTRAINT SYS_C007019 FOREIGN KEY (BOOK_NO)
	REFERENCES HR.SAMPLE_BOOKS (BOOK_NO)
;
...
ALTER TABLE HR.SAMPLE_BOOK_ANSWERS
	ADD CONSTRAINT SYS_C007030 FOREIGN KEY (QUESTION_NO)
...
ALTER TABLE HR.SAMPLE_BOOK_QUESTIONS
	ADD CONSTRAINT SYS_C007027 FOREIGN KEY (USER_ID)
	REFERENCES HR.SAMPLE_BOOK_USERS (USER_ID)
;
