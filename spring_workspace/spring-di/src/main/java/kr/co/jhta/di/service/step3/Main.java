...
public class Main {
	...
	public static void main(String[] args) {
		/*
		 * 1. Reporter객체는 더 이상 자신이 의존하는 객체를 생성하지 않는다.
		 * 2. Reporter객체는 어떤 종류의 객체가 필요한지, 그리고 필요한 객체를 전달받는 setter 메소드를 가지고 있다. 
		 * 3. Reporter의 주요 기능을 사용하기 위해서는 반드시 Reporter객체가 의존하는 객체를 제공해 줄 필요가 있다.
		 * 4. Reporter객체는 더 이상 의존하는 객체에 대한 생성 책임이 없어지고,
