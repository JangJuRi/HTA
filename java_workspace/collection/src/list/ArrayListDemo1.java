...
public class ArrayListDemo1 {
	...
	public static void main(String[] args) {
		...
		/*
		 * ArrayList의 특징
		 * 0. 저장했던 순서대로 다시 꺼낼 수 있다. (순서 보장)
		 * 1. 타입 파라미터<E>는 특정 타입만 저장하는 콜렉션을 생성한다. (타입 안전성)
		 * 2. 저장소의 크기를 별도로 지정할 필요가 없다.
		 * 3. 더 이상 저장할 공간이 없으면 공간의 크기를 자동으로 조절한다.
		 * 4. 저장할 때 인덱스를 별도로 지정할 필요가 없다. (자동으로 맨 끝에 저장된다.)
		...
		// 2. Iterator 사용
		//		1. 조회가 가능하다.
		//		2. 삭제가 가능하다. (Iterator에서 삭제하면 ArrayList에서도 삭제된다.
