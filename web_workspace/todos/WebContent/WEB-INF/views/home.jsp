...
function updateTodoStatus(status) {
    ...
    xhr.onreadystatechange = function(){
       if(xhr.readyState == 4 && xhr.status == 200){
           ...
           document.getElementById("card-todo-status-" + todoNo).textContent = resData.status;
           document.getElementById("card-todo-status-" + todoNo).className = 'badge ' + resData.statusClass;
       }
    }
