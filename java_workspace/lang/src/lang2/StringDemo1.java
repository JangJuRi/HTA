...
public class StringDemo1 {
	...
	public static void main(String[] args) {
		...
		// String replace(CharSequence old, CharSequence nw) : 문자열에서 지정된 문자열(old)을 새 문자열(nw)로 변환한 새로운 문자열을 반환한다.
		...
		// boolean contains(CharSequence s) : 문자열에 지정된 문자열이 포함되어있으면 true를 반환한다.
