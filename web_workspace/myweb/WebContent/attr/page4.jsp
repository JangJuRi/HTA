...
<%
	...
	// PageContext, HttpServletContext, HttpSession, ServletContext객체에 속성값 담기
	...
	// PageContext, HttpServletContext, HttpSession, ServletContext객체에 저장된 속성값 꺼내기
	...
	System.out.println("page4.jsp의 HttpServletContext에서 조회한 값  : " + requestValue);
	System.out.println("page4.jsp의 HttpSession에서 조회한 값  : " + sessionValue);
	System.out.println("page4.jsp의 ServletContext에서 조회한 값  : " + applicationValue);
