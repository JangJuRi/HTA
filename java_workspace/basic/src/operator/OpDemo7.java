...
public class OpDemo7 {
	public static void main(String[] args) {
		...
		System.out.println("유상 수리 여부 : " + isPay);
		System.out.println("무상 수리 여부 : " + isPay2);
		
		//당일 구매금액이 100만원 이상이고, 100번째, 200번째, 300번째, ... 에 방문한 고객은 사은품을 지급한다.(AND결합)
		int orderPrice = 9000000;
		int count = 500;
		...
		System.out.println("전액 장학금 지원 여부 : " + isScholarship);		
