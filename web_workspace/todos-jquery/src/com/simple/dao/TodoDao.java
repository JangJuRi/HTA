...
public class TodoDao {
	...
	public void insertTodo(Todo todo) throws SQLException {
		...
		pstmt.setDate(4, new Date(todo.getDay().getTime()));
		pstmt.setString(5, StringUtil.nullToValue(todo.getStatus(), "처리예정"));
	...
	public void updateTodo(Todo todo) throws SQLException {
		...
		pstmt.setDate(3, new Date(todo.getDay().getTime()));
		pstmt.setDate(4, new Date(todo.getCompletedDay().getTime()));
